-- COMPLETE GUIDE SETUP - Table + Security Fixes
...
-- Step 2: Create secure RLS policies (same as Edit Contact)
...
-- Step 5: Verify setup
SELECT 'Guide table and policies created successfully!' as status;
SELECT * FROM guide_content WHERE id = 'guide-page';
SELECT policyname, cmd, roles FROM pg_policies WHERE tablename = 'guide_content' ORDER BY policyname;
